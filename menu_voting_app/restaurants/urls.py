...
from .views import (
    RestaurantCreateView,          # View for creating new restaurants
    MenuCreateView,                # View for uploading new menu items
    MenuListView,                  # View for listing menus for a specific restaurant
    MenuDetailView,                # View for retrieving menu details for the current day
    VoteMenuAPIView,               # View for creating or submitting votes for menus
    VoteResultsForCurrentDayAPIView  # View for retrieving vote results for the current day
)

urlpatterns = [
    # URL pattern for creating a new restaurant
    # URL: /create-restaurant/
    path('create-restaurant/', RestaurantCreateView.as_view(), name='restaurant-create'),
    ...
    path('restaurant-votes/', VoteResultsForCurrentDayAPIView.as_view(), name='vote-results-for-current-day'),
]
